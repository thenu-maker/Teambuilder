import { q as P, M as R, b as g, j as r, C as B, r as c, u as Ae, v as C, w as F, x as z, O as oe, A, y as u, z as l, B as Ie, D as Te, F as Oe, G, H as ce, E as p, I as Ue, k as $e, l as He, P as je, J as Be, V as Ne, K as Ce, L as $, N as Je, Q as q, R as X, S as Ve, T as N, U as Fe, W as qe, X as Se, Y as he, Z as ke, _ as Xe, $ as Ye, a0 as We, a1 as Ge, a2 as Ke, a3 as Ze, a4 as Qe, a5 as et, a6 as tt, a7 as it, a8 as nt, a9 as Re, aa as ot, ab as se, ac as st } from "./copilot-C13q4MqC.js";
import { n as L, r as I } from "./state-9zf3mz-0.js";
import { e as M, m as ae } from "./overlay-monkeypatch-CBuytWs_.js";
import { i as d } from "./icons-BuP5__m2.js";
import { e as D } from "./early-project-state-CqEloDes.js";
const at = 1, pe = 36, rt = 18;
function lt(e, t) {
  if (e.length === 0)
    return;
  const i = dt(e, t);
...
function dt(e, t) {
  ...
  return e.map((s) => {
    const a = s.panelInfo;
    return a && !a.expanded ? pe : (t.offsetHeight - (t.position === "bottom" ? rt : 0) - o * pe - i * at) / n;
  });
}
var ct = Object.defineProperty, ht = Object.getOwnPropertyDescriptor, _ = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? ht(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && ct(t, i, o), o;
};
...
let S = class extends R {
    ...
    super(...arguments), this.position = "right", this.opened = !1, this.keepOpen = !1, this.resizing = !1, this.closingForcefully = !1, this.draggingSectionPanel = null, this.documentMouseUpListener = () => {
      ...
      e.stopPropagation(), e.preventDefault(), requestAnimationFrame(() => {
        ...
        if (this.position === "right") {
          ...
          this.style.setProperty("--size", `${o}px`), B.saveDrawerSize(this.position, o), n = { width: o };
        } else if (this.position === "left") {
          const o = t;
          this.style.setProperty("--size", `${o}px`), B.saveDrawerSize(this.position, o), n = { width: o };
        } else if (this.position === "bottom") {
          const o = document.body.clientHeight - i;
          this.style.setProperty("--size", `${o}px`), B.saveDrawerSize(this.position, o), n = { height: o };
        }
  ...
  connectedCallback() {
    super.connectedCallback(), this.reaction(
      ...
      (t) => {
        t === oe.DragAndDrop && !this.opened && !this.keepOpen ? this.style.setProperty("pointer-events", "none") : this.style.setProperty("pointer-events", "auto");
      }
    ), this.reaction(
      ...
      () => r.active,
      () => {
        if (!r.active || !u.isActivationAnimation() || r.activatedFrom === "restore" || r.activatedFrom === "test")
          return;
        const t = c.getAttentionRequiredPanelConfiguration();
  ...
  refreshSplit() {
    lt(this.getAllPanelsOrdered(), this);
  }
};
_([
...
var pt = Object.defineProperty, ut = Object.getOwnPropertyDescriptor, De = (e, t, i, n) => {
...
class gt {
  ...
  dragging(t, i) {
    const n = i.clientX, o = i.clientY, s = n - this.offsetX, a = n - this.offsetX + t.getBoundingClientRect().width, h = o - this.offsetY, f = o - this.offsetY + t.getBoundingClientRect().height;
    return this.adjust(t, s, h, a, f);
  }
  adjust(t, i, n, o, s) {
    let a, h, f, v;
    const y = document.documentElement.getBoundingClientRect().width, W = document.documentElement.getBoundingClientRect().height;
    return (o + i) / 2 < y / 2 ? (t.style.setProperty("--left", `${i}px`), t.style.setProperty("--right", ""), v = void 0, a = Math.max(0, i)) : (t.style.removeProperty("--left"), t.style.setProperty("--right", `${y - o}px`), a = void 0, v = Math.max(0, y - o)), (n + s) / 2 < W / 2 ? (t.style.setProperty("--top", `${n}px`), t.style.setProperty("--bottom", ""), f = void 0, h = Math.max(0, n)) : (t.style.setProperty("--top", ""), t.style.setProperty("--bottom", `${W - s}px`), h = void 0, f = Math.max(0, W - s)), {
      left: a,
      right: v,
      top: h,
      bottom: f
...
const ue = "https://github.com/JetBrains/JetBrainsRuntime/releases";
function vt(e, t) {
  if (!t)
    return !0;
  const [i, n, o] = t.split(".").map((f) => parseInt(f)), [s, a, h] = e.split(".").map((f) => parseInt(f));
  if (i < s)
    return !0;
  if (i === s) {
    if (n < a)
...
let w = class extends R {
  ...
  render() {
    ...
    return l`
      ...
      <div part="footer">
        <vaadin-button
          id="close"
          @click="${() => c.updatePanel(re.tag, { floating: !1 })}"
          >Close
        </vaadin-button>
      </div>
    `;
  ...
  renderPluginIsNotInstalledContent(e) {
    ...
    return e.intellij ? (t = Be, i = "Install from JetBrains Marketplace") : e.vscode && (t = Ne, i = "Install from VSCode Marketplace"), l`
      <div>
  ...
  renderHotswapAgentJdkSection(e) {
    const t = r.jdkInfo?.extendedClassDefCapable, i = this.downloadStatusMessages?.[this.downloadStatusMessages.length - 1] === ge;
    return l`
      <div class="inner-section">
        <details class="inner" .open="${!t}">
          <summary>
          ...
          <div class="hint">
            ...
            <ul>
              ${e.intellij && vt("1.3.0", r.idePluginState?.version) ? l` <li>Upgrade to the latest IntelliJ plugin</li>` : p}
              ...
              <li>
                ${e.intellij || e.vscode ? l`If there is a problem, you can manually
                      <a target="_blank" href="${ue}">download JetBrains Runtime JDK</a> and set up
                      your debug configuration to use it.` : l`<a target="_blank" href="${ue}">Download JetBrains Runtime JDK</a> and set up
  ...
  async downloadJetbrainsRuntime(e) {
    return e.target.disabled = !0, e.preventDefault(), this.downloadStatusMessages = [], $e(`${je}set-up-vs-code-hotswap`, {}, (t) => {
      t.data.error ? (He("Error downloading JetBrains runtime", t.data.error), this.downloadStatusMessages = [...this.downloadStatusMessages, "Download failed"]) : this.downloadStatusMessages = [...this.downloadStatusMessages, ge];
    });
  }
...
window.Vaadin.copilot.plugins.push(bt);
c.addPanel(re);
var wt = Object.getOwnPropertyDescriptor, yt = (e, t, i, n) => {
...
let fe = class extends R {
  ...
  render() {
    const e = Ce(), t = e.status === "warning" || e.status === "error";
    return l`
      ...
      <div aria-hidden="true" class="suffix">
        ${t ? l`<div class="dot ${e.status}"></div>` : p}
      </div>
    `;
  }
};
...
let me = class extends R {
  ...
  render() {
    ...
    return l`
      ...
      <div class="content">
        ...
        ${e ? l` <span class="warning"> ${e} </span> ` : p}
      </div>
  ...
  renderPortrait() {
    return r.userInfo?.portraitUrl ? l`<div
        class="portrait"
        style="background-image: url('https://vaadin.com${r.userInfo.portraitUrl}')"></div>` : p;
  }
  renderDot() {
    return r.userInfo?.validLicense ? p : $.active || $.expired ? l`<div class="dot warning"></div>` : p;
  }
};
me = Pt([
...
function m(e) {
  return Ee("vaadin-menu-bar-item", e);
}
function Z(e) {
  return Ee("vaadin-context-menu-item", e);
}
function Ee(e, t) {
  ...
  if (t.style && (i.className = t.style), t.icon)
    if (typeof t.icon == "string") {
      ...
      i.append(ve(t.icon.strings[0]));
  if (t.label) {
    const n = document.createElement("span");
    n.className = "label", n.innerHTML = t.label, i.append(n);
  } else if (t.component) {
    const n = Je(t.component) ? t.component : document.createElement(t.component);
    i.append(n);
  }
  if (t.hint) {
    const n = document.createElement("span");
  ...
  if (t.suffix)
    if (typeof t.suffix == "string") {
      ...
      i.append(ve(t.suffix.strings[0]));
  return i;
}
function ve(e) {
  if (!e) return null;
...
function ze(e) {
  return $e("copilot-switch-user", { username: e }, (t) => t.data.error ? (q({ type: X.ERROR, message: "Unable to switch user", details: t.data.error.message }), !1) : !0);
}
var At = Object.defineProperty, It = Object.getOwnPropertyDescriptor, Y = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? It(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && At(t, i, o), o;
};
const $t = 8;
function Ct() {
  ...
  return e.label = "Username to Switch To", e.style.width = "100%", e.autocomplete = "off", e.addEventListener("click", async (t) => {
    ...
    if (t.stopPropagation(), t.key === "Enter") {
      const i = e.value;
      if (await ze(i)) {
        const o = u.getRecentSwitchedUsernames();
        u.setRecentSwitchedUsernames(qe([i, ...o])), window.location.reload();
      }
    }
  }), e;
}
let j = class extends R {
  constructor() {
    super(...arguments), this.initialMouseDownPosition = null, this.dragging = !1, this.items = [], this.mouseDownListener = (e) => {
      ...
      if (this.initialMouseDownPosition && !this.dragging) {
        const { clientX: t, clientY: i } = e;
        this.dragging = Math.abs(t - this.initialMouseDownPosition.x) + Math.abs(i - this.initialMouseDownPosition.y) > $t;
      }
      ...
      if (this.initialMouseDownPosition = null, document.removeEventListener("mousemove", this.documentDraggingMouseMoveEventListener), this.dragging) {
        ...
        u.setActivationButtonPosition(t), this.setOverlayVisibility(!0);
      } else
      ...
      if (!o)
        return !1;
      const s = o.getBoundingClientRect(), a = n.getBoundingClientRect(), h = Math.min(s.x, a.x), f = Math.min(s.y, a.y), v = Math.max(s.width, a.width), y = s.height + a.height;
      return Ae(new DOMRect(h, f, v, y), e.clientX, e.clientY);
  ...
  connectedCallback() {
    ...
    const e = u.getActivationButtonPosition();
    e ? (this.style.setProperty("--left", `${e.left}px`), this.style.setProperty("--bottom", `${e.bottom}px`), this.style.setProperty("--right", `${e.right}px`), this.style.setProperty("--top", `${e.top}px`)) : (this.style.setProperty("--bottom", "var(--space)"), this.style.setProperty("--right", "var(--space)")), g.on("document-activation-change", (t) => {
      ...
      () => [
        r.active,
        r.idePluginState,
        u.isActivationAnimation(),
        u.isActivationShortcut(),
        u.isSendErrorReportsAllowed(),
        u.isAIUsageAllowed()
      ],
      () => {
        this.generateItems();
  ...
  generateItems() {
    const e = r.active, t = e && !!r.idePluginState?.supportedActions?.find((s) => s === "undo"), i = [];
    if (D.springSecurityEnabled) {
      const s = u.getRecentSwitchedUsernames();
      i.push(
        ...s.map((a) => ({
          component: m({
            label: a
          ...
          action: async () => {
            await ze(a) && window.location.reload();
          }
        }))
      ), i.length > 0 && i.unshift({
        component: m({ label: "Recently Used Usernames" }),
        disabled: !0
      });
    }
    let n;
    u.isAIUsageAllowed() === "ask" ? n = "Always Ask" : u.isAIUsageAllowed() === "no" ? n = "Disabled" : n = "Enabled";
    const o = [
      {
        text: "Vaadin Copilot",
        children: [
          { visible: e, component: m({ component: "copilot-activation-button-user-info" }) },
          { visible: e, component: "hr" },
          {
            component: m({ component: "copilot-activation-button-development-workflow" }),
            action: Ve
          },
          { visible: e, component: "hr" },
          {
            visible: D.springSecurityEnabled,
            component: m({
              icon: d.user,
            ...
            children: [
              {
                component: m({
                  ...
                  suffix: u.isActivationShortcut() ? '<div aria-hidden="true" class="switch on"></div>' : '<div aria-hidden="true" class="switch off"></div>'
                }),
                action: () => {
                  u.setActivationShortcut(!u.isActivationShortcut());
                }
              },
              {
                component: m({
                  ...
                  suffix: u.isActivationAnimation() ? '<div aria-hidden="true" class="switch on"></div>' : '<div aria-hidden="true" class="switch off"></div>'
                }),
                action: () => {
                  u.setActivationAnimation(!u.isActivationAnimation());
                }
              },
              {
                component: m({
                ...
                action: () => {
                  let s;
                  const a = u.isAIUsageAllowed();
                  a === "ask" ? s = "yes" : a === "no" ? s = "ask" : s = "no", u.setAIUsageAllowed(s);
                }
              },
              {
                component: m({
                  ...
                  suffix: u.isSendErrorReportsAllowed() ? '<div aria-hidden="true" class="switch on"></div>' : '<div aria-hidden="true" class="switch off"></div>'
                }),
                action: () => {
                  u.setSendErrorReportsAllowed(!u.isSendErrorReportsAllowed());
                }
              },
              { component: "hr" },
              {
          ...
          },
          {
            component: m({
              icon: d.vaadinLogo,
              label: "Copilot",
              hint: u.isActivationShortcut() ? N.toggleCopilot : void 0,
  ...
  firstUpdated() {
    this.setMenuBarOnClick(), ae(this.shadowRoot);
  }
};
Y([
  M("vaadin-menu-bar")
], j.prototype, "menubar", 2);
Y([
  I()
...
var St = Object.defineProperty, kt = Object.getOwnPropertyDescriptor, O = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? kt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
  return n && o && St(t, i, o), o;
};
const b = "resize-dir", Q = "floating-resizing-active";
let k = class extends R {
  constructor() {
    super(...arguments), this.panelTag = "", this.dockingItems = [
      ...
      if (!this.hasAttribute(Q) || e.button !== 0)
        return;
      ...
      this.panelInfo?.floating && (this.floatingResizingStarted || (this.removeAttribute("resizing"), this.removeAttribute(Q), this.removeAttribute("dragging"), this.style.removeProperty("--resize-cursor"), this.removeAttribute(b)));
      ...
      const { width: t, height: i } = this.getBoundingClientRect(), { left: n, top: o, bottom: s, right: a } = x.anchor(this), h = window.getComputedStyle(this.container), f = Number.parseInt(h.borderTopWidth, 10), v = Number.parseInt(h.borderBottomWidth, 10);
    ...
    `;
      ...
      if (this.panelInfo)
        if (e.stopPropagation(), he(this), this.panelInfo?.floating)
      ...
      () => {
        requestAnimationFrame(() => {
          this.toggleAttribute(
            ...
            r.operationInProgress === oe.DragAndDrop && this.panelInfo?.floating && !this.panelInfo.showWhileDragging
          );
        });
      }
    ), this.reaction(
  ...
  setResizePosition(e, t, i) {
    const n = this.rectangleBeforeResizing, o = 0, s = window.innerWidth, a = 0, h = window.innerHeight, f = Math.max(o, Math.min(s, t)), v = Math.max(a, Math.min(h, i));
    if (e === "left")
  ...
  getPopupButtonIcon() {
    return this.panelInfo ? this.panelInfo.panel === void 0 ? d.x : this.panelInfo.floating ? this.panelInfo.panel === "bottom" ? d.layoutBottom : this.panelInfo.panel === "left" ? d.layoutLeft : this.panelInfo.panel === "right" ? d.layoutRight : p : d.share : p;
  }
  renderHelpButton() {
  ...
  changeDockingPanel(e) {
    ...
    if (this.panelInfo?.panel !== t) {
      ...
      he(this), c.updatePanel(this.panelInfo.tag, { panel: t, panelOrder: i + 1 });
    }
...
g.on("undoRedo", (e) => {
  const i = { files: e.detail.files ?? We(), uiId: Ge() }, n = e.detail.undo ? "copilot-plugin-undo" : "copilot-plugin-redo", o = e.detail.undo ? "undo" : "redo";
  Ke(o), Rt(oe.RedoUndo), g.send(n, i);
});
var Dt = Object.getOwnPropertyDescriptor, Et = (e, t, i, n) => {
...
const we = window?.Vaadin?.connectionState?.stateChangeListeners;
we ? we.add((e, t) => {
  e === "loading" && t === "connected" && r.active && le();
...
g.on("copilot-early-project-state", (e) => {
  D.setSpringSecurityEnabled(e.detail.springSecurityEnabled), D.setSpringJpaDataEnabled(e.detail.springJpaDataEnabled), D.setSupportsHilla(e.detail.supportsHilla), D.setUrlPrefix(e.detail.urlPrefix), e.preventDefault();
});
...
const Mt = {
   ...
   */
  run(e) {
    ie || (ie = !0, queueMicrotask(() => Lt())), E.push(e);
    const t = ye;
    return ye += 1, t;
  },
  /**
...
class J {
  ...
  static debounce(t, i, n) {
    return t instanceof J ? t._cancelAsync() : t = new J(), t.setConfig(i, n), t;
  }
  constructor() {
  ...
  setConfig(t, i) {
    this._asyncModule = t, this._callback = i, this._timer = this._asyncModule.run(() => {
      this._timer = null, xe.delete(this), this._callback();
    });
  }
  /**
   ...
   */
  cancel() {
    this.isActive() && (this._cancelAsync(), xe.delete(this));
  }
  /**
...
const H = (e, t) => {
  ...
  for (const n of i) n._$AO?.(t, !1), H(n, t);
  return !0;
}, V = (e) => {
  let t, i;
  do {
...
function _t(e) {
  this._$AN !== void 0 ? (V(this), this._$AM = e, Me(this)) : this._$AM = e;
}
function Tt(e, t = !1, i = 0) {
  const n = this._$AH, o = this._$AN;
  if (o !== void 0 && o.size !== 0) if (t) if (Array.isArray(n)) for (let s = i; s < n.length; s++) H(n[s], !1), V(n[s]);
  else n != null && (H(n, !1), V(n));
  else H(this, e);
}
const Ot = (e) => {
  e.type == Re.CHILD && (e._$AP ??= Tt, e._$AQ ??= _t);
};
class Ut extends it {
  constructor() {
  ...
  _$AO(t, i = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), i && (H(this, t), V(this));
  }
  setValue(t) {
    if (nt(this._$Ct)) this._$Ct._$AI(t, this);
    else {
...
class Ht extends Ut {
  ...
  /** @override */
  update(t, [i, n]) {
    return this.hasChanged(n) ? (this.host = t.options && t.options.host, this.element = t.element, this.renderer = i, this.previousValue === Pe ? this.addRenderer() : this.runRenderer(), this.previousValue = Array.isArray(n) ? [...n] : n, p) : p;
  }
  /** @override */
  reconnected() {
    this.addRenderer();
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
const ee = Symbol("contentUpdateDebouncer");
class de extends Ht {
  /**
   ...
   */
  removeRenderer() {
    this.element[this.rendererProperty] = null, delete this.element[ee];
  }
}
class jt extends de {
  get rendererProperty() {
...
const Jt = se(jt), Vt = se(Bt), Ft = se(Nt);
var qt = Object.defineProperty, Xt = Object.getOwnPropertyDescriptor, _e = (e, t, i, n) => {
  for (var o = n > 1 ? void 0 : n ? Xt(t, i) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (o = (n ? a(t, i, o) : a(o)) || o);
...
let ne = class extends Ie {
  ...
  firstUpdated(e) {
    super.firstUpdated(e), ae(this.renderRoot);
  }
  render() {
